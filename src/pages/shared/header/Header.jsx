...
const Header = () => {
  return (
    <Container>
      ...
      <Container>
        <Navbar.Brand href="#home">The Mahadi News</Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="d-flex align-items-center">
            <img className="me-2" style={{width : 40}} src={profile} alt="" />
            <Nav.Link className="bg-dark text-white px-5 fw-bold" href="#link">Login</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
